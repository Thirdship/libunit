...
class MetricPrefixesTest extends FlatSpec with Matchers {
  ...
  it should "augment edges" in {
    val data: AStarConvertibleUnitData = new AStarConvertibleUnitData(baseUnit, "Time", compressedParseMap, edges).createMetricUnits(List(baseUnit))
	  ...
	  data.aStar.getConversion(baseUnit.baseString, "Ys") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "Ys", 1e-24, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "Zs") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "Zs", 1e-21, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "Es") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "Es", 1e-18, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "Ps") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "Ps", 1e-15, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "Ts") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "Ts", 1e-12, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "Gs") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "Gs", 1e-9, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "Ms") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "Ms", 1e-6, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "ks") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "ks", 1e-3, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "hs") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "hs", 1e-2, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "das") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "das", 1e-1, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "ds") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "ds", 1e1, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "cs") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "cs", 1e2, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "ms") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "ms", 1e3, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "us") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "us", 1e6, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "ns") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "ns", 1e9, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "ps") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "ps", 1e12, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "fs") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "fs", 1e15, 0.1)))
	  data.aStar.getConversion(baseUnit.baseString, "as") should be (Option(new ScalarConversionEdge[String](baseUnit.baseString, "as", 1e18, 0.1)))
  }
