...
/**
  ...
  */
object MassHelpers{
	object Grams     	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new MassTSUnit("g")) }
	object Kilograms 	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new MassTSUnit("kg")) }
	object Milligrams 	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new MassTSUnit("mg")) }
	object Micrograms	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new MassTSUnit("ug")) }

	object Slug     	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new MassTSUnit("slug")) }
	object PoundMass 	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new MassTSUnit("lbm")) }
