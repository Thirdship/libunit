...
object StorageHelpers{
	object Bytes    	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new StorageTSUnit("B")) }
	object Bits     	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new StorageTSUnit("b")) }
	object Kilobytes  	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new StorageTSUnit("KB")) }
	object Megabytes   	{ def apply(value: Double = 1): TSUnitValuePair = TSUnitValuePair(value, new StorageTSUnit("MB")) }
